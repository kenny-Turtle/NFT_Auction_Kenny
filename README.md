...
│   ├── AuctionMarketUpgradeable.test.ts // 升级拍卖逻辑测试
...
Compiled 10 Solidity files with solc 0.8.28 (evm target: cancun)
...
Running Mocha tests
  ...
  AuctionMarketUpgradeable (UUPS)
    ✔ should initialize correctly
    ✔ should create auction successfully
    ✔ should accept ETH bid
    ✔ should refund previous ETH bidder
    ✔ should bid ERC20
    ✔ should refund previous ERC20 bidder
    ✔ should end auction with ETH
    ✔ should end auction with ERC20
    ✔ should return NFT when no bids
    ✔ should get ETH USD price
    ✔ should calculate USD value
    ✔ should trigger onERC721Received
...
USD value of 1 ETH (8 decimals): 300000000000
  ...
  UUPS Upgrade Test
Network: hardhat
Deployed Mock Oracle at: 0xe8D2A1E88c91DCd5433208d4152Cc4F399a7e91d
V1 impl: 0x5067457698Fd6Fa1C6964e416b3f42713513B3dD
Proxy: 0x18E317A7D70d8fBf8e6E893616b52390EbBdb629
V2 impl: 0x4b6aB5F819A515382B0dEB6935D793817bB4af28
Upgraded to V2
    ✔ should deploy and upgrade contract (20055ms)
...
║ contracts/AuctionMarketUpgradeable.sol │ 100.00 │ 100.00      │ -               ║
